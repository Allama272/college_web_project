...
<template>
    <div>
        <div class="min-h-screen bg-gradient-to-t from-cyan-100/50 to-pink-100/50">
            <nav class=" w-full bg-white/50 backdrop-blur-md shadow-md fixed top-0 z-50">
                    ...
                    <div class="flex h-16 justify-between">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                ...
                                <NavLink v-if="$page.props.auth.user.is_admin" :href="route('admin')" :active="route().current('contact')">
                                    Admin
                                </NavLink>
