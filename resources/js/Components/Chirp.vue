   ...
   <div class="p-6 flex space-x-2">
        ...
        <div class="flex-1">
            <div class="flex justify-between items-center">
                ...
                <Dropdown v-if="chirp.user.id === $page.props.auth.user.id">
                    ...
                    <template #content>
                        ...
                        <DropdownLink :class="['hover:bg-rose-200']" as="button" :href="route('chirps.destroy', chirp.id)" method="delete">
                            Delete
                        </DropdownLink>
                    </template>
                </Dropdown>
            ...
            <form v-if="editing" @submit.prevent="form.put(route('chirps.update', chirp.id), { onSuccess: () => editing = false })">
                ...
                <div class="space-x-2">
                    <PrimaryButton class="mt-4" :is-button-disabled="isButtonDisabled">Save</PrimaryButton>
            ...
            <like-button :post="chirp"></like-button>
        </div>
